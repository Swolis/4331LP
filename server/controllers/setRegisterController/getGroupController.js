...
var getGroups = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, ClientModel, closeConnection, client, _b, GroupModel, closeConnection2, getGroups_1, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, GroupModel.find({})];
            case 3:
                getGroups_1 = _c.sent();
                if (getGroups_1.length === 0) {
                    closeConnection2();
                    res.status(404).json({ message: 'No group found.' });
                    return [2 /*return*/];
                }
                closeConnection2();
                res.status(201).json({ getGroups: getGroups_1 });
                return [3 /*break*/, 5];
            case 4:
                error_1 = _c.sent();
