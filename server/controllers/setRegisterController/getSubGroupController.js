...
var getGroups = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, ClientModel, closeConnection, client, _b, SubGroupModel, closeConnection2, getSubGroups, error_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, SubGroupModel.find({})];
            case 3:
                getSubGroups = _c.sent();
                ...
                closeConnection2();
                res.status(201).json({ getSubGroups: getSubGroups });
                return [3 /*break*/, 5];
            case 4:
                error_1 = _c.sent();
