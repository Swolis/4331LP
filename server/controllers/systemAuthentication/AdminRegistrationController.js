...
var AdminRegistrationController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, clientRepository_1.createClient)(userData, req.body.databaseName)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                return [2 /*return*/, res.status(500).json({ messsage: 'Internal Server Error.' })];
